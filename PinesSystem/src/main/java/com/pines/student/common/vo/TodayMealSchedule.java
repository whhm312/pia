...
public class TodayMealSchedule {
	...
	private TodayBreakfastSchedule breakfastSchedule;
	private TodayLunchSchedule lunchSchedule;
	private TodayDinnerSchedule dinnerSchedule;
	...
	public TodayBreakfastSchedule getBreakfastSchedule() {
		return breakfastSchedule;
	}

	public void setBreakfastSchedule(TodayBreakfastSchedule breakfastSchedule) {
		this.breakfastSchedule = breakfastSchedule;
	}

	public TodayLunchSchedule getLunchSchedule() {
		return lunchSchedule;
	}

	public void setLunchSchedule(TodayLunchSchedule lunchSchedule) {
		this.lunchSchedule = lunchSchedule;
	}

	public TodayDinnerSchedule getDinnerSchedule() {
		return dinnerSchedule;
	}

	public void setDinnerSchedule(TodayDinnerSchedule dinnerSchedule) {
	...
	public String toString() {
		return "TodayMealSchedule [totalCount=" + totalCount + ", mealSeq=" + mealSeq + ", branchSeq=" + branchSeq + ", mealDate=" + mealDate + ", formMealDate=" + formMealDate + ", breakfastSeq=" + breakfastSeq + ", lunchSeq=" + lunchSeq + ", dinnerSeq=" + dinnerSeq + ", writerId="
