...
public class DinnerEvaluationDetailResponse {
	...
	public String toString() {
		return "DinnerEvaluationDetailResponse [satisfaction=" + satisfaction + ", detail=" + detail + ", isSpicyMenu=" + isSpicyMenu + ", registerDate=" + registerDate + ", name=" + name + ", nationality=" + nationality + ", sex=" + sex + ", dateOfBirth=" + dateOfBirth
				+ "]";
	}
