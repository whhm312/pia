...
public class AddMealBreakfastScheduleRequest {
	...
	public String toString() {
		return "AddMealBreakfastScheduleRequest [porridgeSeq=" + porridgeSeq + ", breadSeq=" + breadSeq + ", riceSeq=" + riceSeq + ", soupSeq=" + soupSeq + ", spicyMaindishSeq=" + spicyMaindishSeq + ", maindishSeq=" + maindishSeq + ", sidedishSeq1=" + sidedishSeq1
