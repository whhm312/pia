...
public class BreakfastEvaluationDetailResponse {
	...
	public String toString() {
		return "BreakfastEvaluationDetailResponse [satisfaction=" + satisfaction + ", detail=" + detail + ", isSpicyMenu=" + isSpicyMenu + ", registerDate=" + registerDate + ", name=" + name + ", nationality=" + nationality + ", sex=" + sex + ", dateOfBirth=" + dateOfBirth
				+ "]";
	}
