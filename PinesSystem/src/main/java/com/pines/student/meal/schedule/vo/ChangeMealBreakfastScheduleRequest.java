...
public class ChangeMealBreakfastScheduleRequest {
	private int porridgeSeq;
	private int breadSeq;
	private int riceSeq;
	private int soupSeq;
	...
	public int getPorridgeSeq() {
		return porridgeSeq;
	}

	public void setPorridgeSeq(int porridgeSeq) {
		this.porridgeSeq = porridgeSeq;
	}

	public int getBreadSeq() {
		return breadSeq;
	}

	public void setBreadSeq(int breadSeq) {
		this.breadSeq = breadSeq;
	}
	...
	public String toString() {
		return "ChangeMealBreakfastScheduleRequest [porridgeSeq=" + porridgeSeq + ", breadSeq=" + breadSeq + ", riceSeq=" + riceSeq + ", soupSeq=" + soupSeq + ", spicyMaindishSeq=" + spicyMaindishSeq + ", maindishSeq=" + maindishSeq + ", sidedishSeq1=" + sidedishSeq1
				+ ", sidedishSeq2=" + sidedishSeq2 + ", sidedishSeq3=" + sidedishSeq3 + ", etcSeq1=" + etcSeq1 + ", etcSeq2=" + etcSeq2 + ", etcSeq3=" + etcSeq3 + "]";
	}

	public BreakfastSchedule getSchedule() {
		BreakfastSchedule result = new BreakfastSchedule();
		result.setPorridgeMenuSeq(porridgeSeq);
		result.setBreadMenuSeq(breadSeq);
