...
public class ChangeMealLunchScheduleRequest {
	private int riceSeq;
	private int soupSeq;
	...
	public String toString() {
		return "ChangeMealLunchScheduleRequest [riceSeq=" + riceSeq + ", soupSeq=" + soupSeq + ", spicyMaindishSeq=" + spicyMaindishSeq + ", maindishSeq=" + maindishSeq + ", sidedishSeq1=" + sidedishSeq1 + ", sidedishSeq2=" + sidedishSeq2 + ", sidedishSeq3=" + sidedishSeq3
