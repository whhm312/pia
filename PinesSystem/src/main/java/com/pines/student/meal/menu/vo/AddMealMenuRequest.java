...
public class AddMealMenuRequest {
	...
	public String toString() {
		return "AddMealMenuRequest [branchSeq=" + branchSeq + ", menuType=" + menuType + ", menuKorName=" + menuKorName + ", menuEngName=" + menuEngName + ", isUsed=" + isUsed + ", isSpicy=" + isSpicy + "]";
	}
