...
public class DinnerScheduleResponse {
	private int riceSeq;
	private int soupSeq;
	...
	public String toString() {
		return "DinnerScheduleResponse [riceSeq=" + riceSeq + ", soupSeq=" + soupSeq + ", spicyMaindishSeq=" + spicyMaindishSeq + ", maindishSeq=" + maindishSeq + ", sidedishSeq1=" + sidedishSeq1 + ", sidedishSeq2=" + sidedishSeq2 + ", sidedishSeq3=" + sidedishSeq3 + ", etcSeq1="
				+ etcSeq1 + ", etcSeq2=" + etcSeq2 + ", etcSeq3=" + etcSeq3 + "]";
	}
