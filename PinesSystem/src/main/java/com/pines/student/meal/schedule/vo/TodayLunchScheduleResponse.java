...
public class TodayLunchScheduleResponse {
	...
	public String toString() {
		return "TodayLunchScheduleResponse [riceName=" + riceName + ", soupName=" + soupName + ", spicyMaindishName=" + spicyMaindishName + ", maindishName=" + maindishName + ", sidedishName1=" + sidedishName1 + ", sidedishName2=" + sidedishName2 + ", sidedishName3="
