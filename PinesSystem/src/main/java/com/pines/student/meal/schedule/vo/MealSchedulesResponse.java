...
public class MealSchedulesResponse {
	...
	public String toString() {
		return "MealSchedulesResponse [mealSeq=" + mealSeq + ", menuDate=" + menuDate + ", satisfactionGoodCount=" + satisfactionGoodCount + ", satisfactionFineCount=" + satisfactionFineCount + ", satisfactionNoGoodCount=" + satisfactionNoGoodCount + ", detailCount="
				+ detailCount + ", registerDate=" + registerDate + ", writer=" + writer + "]";
	}
