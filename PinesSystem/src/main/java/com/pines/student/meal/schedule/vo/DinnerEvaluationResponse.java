...
public class DinnerEvaluationResponse {
	...
	private List<DinnerEvaluationDetailResponse> comments;
	...
	public List<DinnerEvaluationDetailResponse> getComments() {
		return comments;
	}

	public void setComments(List<DinnerEvaluationDetailResponse> comments) {
		this.comments = comments;
	}

	@Override
	public String toString() {
		return "DinnerEvaluationResponse [menuKor=" + menuKor + ", menuEng=" + menuEng + ", totalCount=" + totalCount + ", goodCount=" + goodCount + ", fineCount=" + fineCount + ", nogoodCount=" + nogoodCount + ", comments=" + comments + "]";
	}
