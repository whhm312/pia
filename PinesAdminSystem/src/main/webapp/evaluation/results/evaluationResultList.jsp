                ...
                <ul class="list-unstyled">
                    ...
                    <li class="has-submenu active"><a href="/study/studyList.jsp"><i class="zmdi zmdi-collection-text"></i> <span class="nav-label">Academy</span></a>
                        <ul class="list-unstyled">
                            ...
                            <!-- <li class="active"><a href="/evaluation/results/evaluationResultList.jsp">Evaluation Results</a></li> -->
                                        ...
                                        <table class="table table-hover" id="listTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="10%">Term</th>
                                                    <th class="text-center" width="15%">Term Student's Count</th>
                                                    <th class="text-center" width="15%">Answered Count</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
